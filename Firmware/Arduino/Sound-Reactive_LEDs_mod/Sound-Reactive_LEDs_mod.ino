...
#define LED_TOTAL 66  //Change this to the number of LEDs in your strand.
#define LED_HALF  LED_TOTAL/2
#define VISUALS   1   //Change this accordingly if you add/remove a visual in the switch-case in Visualize()
